...
```bash
# Ubuntu 22.04 (Jammy)
wget https://github.com/programmablemd/packages/releases/download/v0.110.0/spry_0.110.0-ubuntu22.04u1_amd64.deb
sudo dpkg -i spry_0.110.0-ubuntu22.04u1_amd64.deb

# Debian 12 (Bookworm)
wget https://github.com/programmablemd/packages/releases/download/v0.110.0/spry_0.110.0-debian12u1_amd64.deb
sudo dpkg -i spry_0.110.0-debian12u1_amd64.deb
```
...
wget https://github.com/programmablemd/packages/releases/download/v0.110.0/spry-macos.tar.gz
...
# https://github.com/programmablemd/packages/releases/download/v0.110.0/spry-windows.zip
